...
export const breakpointQueryDesktopOnly = "(min-width: 64.0625rem) and (max-width: 80rem)";
...
export const fontFamilyLarken = "'Larken', 'Skyscanner Relative', 'Noto Sans', 'Noto Sans JP', sans-serif";
